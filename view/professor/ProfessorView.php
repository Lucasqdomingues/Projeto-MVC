...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="close-modal">Sair</button>
            ...
            <tbody>
                <?php foreach ($professores as $professorAtual) { ?>
                    <tr>
                        ...
                        <!--<a href="/<?php echo FOLDER; ?>?controller=Estudante&acao=excluir&id=<?php echo $professorAtual['id']; ?>" class="btn btn-primary">Excluir</a> -->
    ...
    <script>
        $("#delete-button").on("click", function() {
            ...
            console.log("O usuário para ser deletado é: " + idUsuario);
        });
